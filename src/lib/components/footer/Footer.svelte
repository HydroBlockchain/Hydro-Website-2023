    ...
    <div class="footer-container" id="card-background">
        ...
        <div class="social-media-wrapper">
            <div class="social-media">
                <a class="social-icon" href={item[0].link} aria-label="Footer Logo" target="_blank"
                ...
                <a class="social-icon" href={item[1].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
                ...
                <a class="social-icon" href={item[2].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
                ...
                <a class="social-icon" href={item[3].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
                ...
                <a class="social-icon" href={item[4].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
            ...
            <div class="social-media">
                <a class="social-icon" href={item[5].link} target="_blank" rel="noopener noreferrer">
                    <svg id="social-link-logo" viewBox="0 0 38 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a class="social-icon" href={item[6].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
                ...
                <a class="social-icon" href={item[7].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
                ...
                <a class="social-icon" href={item[8].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
                ...
                <a class="social-icon" href={item[9].link} aria-label="Footer Logo" target="_blank"
                    rel="noopener noreferrer">
