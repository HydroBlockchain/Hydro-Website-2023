...
<!-- Credit to https://twitter.com/dokstep for the amazing template! -->
<div class="full" id="card-background">
    <div class="statement">
        Discover the depths of Web3 & GameFi with Hydro! <br>
        <div class="button" href="/tech">Explore</div>
      </div>
    ...
    3jXbAAAAAElFTkSuQmCC"
                ...
                <linearGradient
                    ...
                    y2="805.9159"
                >
                    <stop offset="0" style="stop-color:#256c95" />
            ...
            <g id="d-appswrapper">
                <g id="d-app">
                    <g>
                        ...
                        >
                            <stop offset="0" style="stop-color:#752de9" />
                            <stop offset="0.2627" style="stop-color:#752de9" />
                            <stop offset="0.7192" style="stop-color:#752de9" />
                            <stop offset="1" style="stop-color:#752de9" />
                        </linearGradient>
                        <path
                            fill="url(#SVGID_7_)"
                        ...
                        >
                            ...
                            <stop offset="1" style="stop-color:#5956ed" />
                        </linearGradient>
                        <path
                            fill="url(#SVGID_8_)"
                    ...
                    <g>
                        <linearGradient
                            ...
                            gradientTransform="matrix(1 0 0 -1 0 1900)"
                        >
                            <stop offset="0" style="stop-color:#1d3ba6" />
                            <stop offset="0.2302" style="stop-color:#1d3ba6" />
                            <stop offset="0.4367" style="stop-color:#1d3ba6" />
                            <stop offset="0.634" style="stop-color:#1d3ba6" />
                            <stop offset="0.8245" style="stop-color:#1d3ba6" />
                            <stop offset="1" style="stop-color:#1d3ba6" />
                        </linearGradient>
                        <path
                            fill="url(#SVGID_9_)"
                        ...
                        <linearGradient
                            ...
                            gradientTransform="matrix(1 0 0 -1 0 1900)"
                        >
                            <stop offset="0" style="stop-color:#4583e6" />
                            <stop offset="1" style="stop-color:#4583e6" />
                        </linearGradient>
                        <path
                            fill="url(#SVGID_10_)"
                ...
                <g>
                    ...
                    />
                    <g>
                        <circle fill="#489fe6" cx="553.5" cy="364.8" r="1.5" />
                        <circle fill="#489fe6" cx="518.5" cy="307.8" r="0.5" />
                        <circle fill="#FFFFFF" cx="600.2" cy="379.4" r="0.7" />
                        <circle fill="#48e6de" cx="581.8" cy="310.5" r="0.7" />
                        ...
                        <circle fill="#489fe6" cx="576.7" cy="339.6" r="0.7" />
                        ...
                        <circle fill="#48e6de" cx="604.2" cy="357.9" r="1.4" />
                        <circle fill="#FFFFFF" cx="521.8" cy="341" r="0.7" />
                        <circle fill="#48e6de" cx="506.9" cy="322" r="0.7" />
                        <circle fill="#48e6de" cx="513" cy="361.5" r="0.7" />
                        <circle fill="#48e6de" cx="554.8" cy="313.4" r="1" />
                        <circle fill="#48e6de" cx="539.3" cy="341.7" r="1.4" />
            ...
            <g id="d-apps2wrapper">
                ...
                <g>
                    ...
                    />
                    <g>
                        <circle fill="#489fe6" cx="1249.2" cy="825.7" r="1.5" />
                        <circle fill="#489fe6" cx="1214.2" cy="768.7" r="0.5" />
                        <circle fill="#FFFFFF" cx="1295.9" cy="840.3" r="0.7" />
                        <circle fill="#48e6de" cx="1277.5" cy="771.4" r="0.7" />
                        ...
                        <circle fill="#489fe6" cx="1272.4" cy="800.5" r="0.7" />
                        ...
                        <circle fill="#48e6de" cx="1300" cy="818.8" r="1.4" />
                        <circle fill="#FFFFFF" cx="1217.5" cy="801.9" r="0.7" />
                        <circle fill="#48e6de" cx="1202.6" cy="782.9" r="0.7" />
                        <circle fill="#48e6de" cx="1208.8" cy="822.4" r="0.7" />
                        <circle fill="#48e6de" cx="1250.5" cy="774.3" r="1" />
                        <circle fill="#48e6de" cx="1235.1" cy="802.6" r="1.4" />
            ...
            <g id="topgreyblocks" opacity="0.7">
                <g>
                    ...
                    >
                        <stop offset="0" style="stop-color:#5956ed" />
                        <stop offset="0.2774" style="stop-color:#5956ed" />
                        <stop offset="0.7283" style="stop-color:#5956ed" />
                        <stop offset="1" style="stop-color:#5956ed" />
                    </linearGradient>
                    <polygon
                        fill="url(#SVGID_14_)"
                    ...
                    >
                        <stop offset="0" style="stop-color:#5956ed" />
                        <stop offset="0.2132" style="stop-color:#5956ed" />
                        <stop offset="0.4462" style="stop-color:#5956ed" />
                        <stop offset="0.6625" style="stop-color:#5956ed" />
                        <stop offset="0.8538" style="stop-color:#5956ed" />
                        <stop offset="1" style="stop-color:#5956ed" />
                    </linearGradient>
                    <polygon
                        fill="url(#SVGID_15_)"
                    ...
                    >
                        <stop offset="0" style="stop-color:#5956ed" />
                        <stop offset="0.219" style="stop-color:#5956ed" />
                        <stop offset="0.5607" style="stop-color:#5956ed" />
                        <stop offset="0.833" style="stop-color:#5956ed" />
                        <stop offset="1" style="stop-color:#5956ed" />
                    </linearGradient>
                    <polygon
                        fill="url(#SVGID_16_)"
    ...
    RK5CYII="
            ...
            555.6,608.9 		"
                ...
                >
                    ...
                    <stop
                        offset="0.2113"
                        style="stop-color:#489fe6;stop-opacity:0.2113"
                    />
                    <stop
                        offset="0.4448"
                        style="stop-color:#489fe6;stop-opacity:0.4448"
                    />
                    <stop
                        offset="0.6617"
                        style="stop-color:#489fe6;stop-opacity:0.6617"
                    />
                    <stop
                        offset="0.8535"
                        style="stop-color:#489fe6;stop-opacity:0.8535"
                    />
                    <stop offset="1" style="stop-color:#6cb2f4" />
                </linearGradient>
                <polygon
                    class="particlespoly"
                    fill="url(#SVGID_42_)"
            ...
            <g id="redblocksparticles">
                <g>
                    ...
                    >
                        <stop
                            offset="0"
                            style="stop-color:#489fe6;stop-opacity:0"
                        />
                        <stop offset="1" style="stop-color:#489fe6" />
                    </linearGradient>
                    <polygon
                        fill="url(#SVGID_91_)"
                ...
                1141.3,409 			"
                    ...
                    />
                    <g>
                        <circle cx="1115.2" cy="508.7" r="1.5" fill="#489fe6" />
                        <circle cx="1080.2" cy="451.7" r="0.5" fill="#489fe6" />
                        <circle cx="1161.9" cy="523.3" r="0.7" fill="#FFFFFF" />
                        <circle cx="1143.5" cy="454.4" r="0.7" fill="#48e6de" />
                        ...
                        <circle cx="1138.4" cy="483.5" r="0.7" fill="#489fe6" />
                        ...
                        <circle cx="1166" cy="501.8" r="1.4" fill="#48e6de" />
                        <circle cx="1083.5" cy="484.9" r="0.7" fill="#FFFFFF" />
                        <circle cx="1068.6" cy="465.9" r="0.7" fill="#48e6de" />
                        <circle cx="1074.8" cy="505.4" r="0.7" fill="#48e6de" />
                        <circle cx="1116.5" cy="457.3" r="1" fill="#48e6de" />
                        <circle cx="1101.1" cy="485.6" r="1.4" fill="#48e6de" />
                ...
                <g>
                    ...
                    />
                    <g>
                        <circle cx="799.2" cy="696.7" r="1.5" fill="#489fe6" />
                        <circle cx="764.2" cy="639.7" r="0.5" fill="#489fe6" />
                        <circle cx="845.9" cy="711.3" r="0.7" fill="#FFFFFF" />
                        <circle cx="827.5" cy="642.4" r="0.7" fill="#48e6de" />
                        ...
                        <circle cx="822.4" cy="671.5" r="0.7" fill="#489fe6" />
                        ...
                        <circle cx="850" cy="689.8" r="1.4" fill="#48e6de" />
                        <circle cx="767.5" cy="672.9" r="0.7" fill="#FFFFFF" />
                        <circle cx="752.6" cy="653.9" r="0.7" fill="#48e6de" />
                        <circle cx="758.8" cy="693.4" r="0.7" fill="#48e6de" />
                        <circle cx="800.5" cy="645.3" r="1" fill="#48e6de" />
                        <circle cx="785.1" cy="673.6" r="1.4" fill="#48e6de" />
                ...
                <g>
                    ...
                    />
                    <g>
                        <circle cx="640.2" cy="789.7" r="1.5" fill="#489fe6" />
                        <circle cx="605.2" cy="732.7" r="0.5" fill="#489fe6" />
                        <circle cx="686.9" cy="804.3" r="0.7" fill="#FFFFFF" />
                        <circle cx="668.5" cy="735.4" r="0.7" fill="#48e6de" />
                        ...
                        <circle cx="663.4" cy="764.5" r="0.7" fill="#489fe6" />
                        ...
                        <circle cx="691" cy="782.8" r="1.4" fill="#48e6de" />
                        <circle cx="608.5" cy="765.9" r="0.7" fill="#FFFFFF" />
                        <circle cx="593.6" cy="746.9" r="0.7" fill="#48e6de" />
                        <circle cx="599.8" cy="786.4" r="0.7" fill="#48e6de" />
                        <circle cx="641.5" cy="738.3" r="1" fill="#48e6de" />
                        <circle cx="626.1" cy="766.6" r="1.4" fill="#48e6de" />
                ...
                <g>
                    ...
                    />
                    <g>
                        <circle cx="485.2" cy="882.7" r="1.5" fill="#489fe6" />
                        <circle cx="450.2" cy="825.7" r="0.5" fill="#489fe6" />
                        <circle cx="531.9" cy="897.3" r="0.7" fill="#FFFFFF" />
                        <circle cx="513.5" cy="828.4" r="0.7" fill="#48e6de" />
                        ...
                        <circle cx="508.4" cy="857.5" r="0.7" fill="#489fe6" />
                        ...
                        <circle cx="536" cy="875.8" r="1.4" fill="#48e6de" />
                        <circle cx="453.5" cy="858.9" r="0.7" fill="#FFFFFF" />
                        <circle cx="438.6" cy="839.9" r="0.7" fill="#48e6de" />
                        <circle cx="444.8" cy="879.4" r="0.7" fill="#48e6de" />
                        <circle cx="486.5" cy="831.3" r="1" fill="#48e6de" />
                        <circle cx="471.1" cy="859.6" r="1.4" fill="#48e6de" />
            ...
            <g>
                <g opacity="0.25">
                    ...
                    >
                        ...
                        <stop offset="0.5984" style="stop-color:#5956ed" />
                        <stop offset="1" style="stop-color:#5956ed" />
                    </linearGradient>
                    <polygon
                        fill="url(#SVGID_48_)"
            ...
            <g id="firstBlock">
                <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0" style="stop-color:#2e5a97" />
                    <stop offset="0.2857" style="stop-color:#2e5a97" />
                    <stop offset="0.75" style="stop-color:#2e5a97" />
                    <stop offset="1" style="stop-color:#2e5a97" />
                </linearGradient>
                <polygon
                    fill="url(#SVGID_49_)"
                ...
                <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0" style="stop-color:#2f7dd6" />
                    <stop offset="0.1701" style="stop-color:#2f7dd6" />
                    <stop offset="0.4158" style="stop-color:#2f7dd6" />
                    <stop offset="0.6441" style="stop-color:#2f7dd6" />
                    <stop offset="0.8458" style="stop-color:#2f7dd6" />
                    <stop offset="1" style="stop-color:#245ace" />
                </linearGradient>
                <polygon
                    fill="url(#SVGID_50_)"
                ...
                <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0" style="stop-color:#48e6de" />
                    <stop offset="5.850000e-02" style="stop-color:#489fe6" />
                    <stop offset="0.6415" style="stop-color:#2e5a97" />
                    <stop offset="1" style="stop-color:#245ace" />
                </linearGradient>
                <polygon
                    fill="url(#SVGID_51_)"
                ...
                >
                    <stop offset="0" style="stop-color:#FFFFFF" />
                    <stop offset="0.2713" style="stop-color:#badbfd" />
                    <stop offset="0.5184" style="stop-color:#83b3fb" />
                    <stop offset="0.7299" style="stop-color:#685bf9" />
                    <stop offset="0.8974" style="stop-color:#3a43e3" />
                    <stop offset="1" style="stop-color:#3a43e3" />
                </linearGradient>
                <polygon
                    fill="url(#SVGID_52_)"
                ...
                >
                    ...
                    <stop offset="0.7299" style="stop-color:#685bf9" />
                    <stop offset="0.8974" style="stop-color:#3a43e3" />
                    <stop offset="1" style="stop-color:#793af8" />
                </linearGradient>
                <polygon
                    fill="url(#SVGID_53_)"
    ...
    CzAAqYTVOPWO2yYAAAAASUVORK5CYII="
                ...
                <g>
                    <g opacity="0.25">
                        ...
                        >
                            ...
                            <stop
                                offset="3.360000e-02"
                                style="stop-color:#5956ed"
                            />
                            <stop offset="0.4566" style="stop-color:#5956ed" />
                            <stop offset="0.7934" style="stop-color:#5956ed" />
                            <stop offset="1" style="stop-color:#5956ed" />
                        </linearGradient>
                        <polygon
                            fill="url(#SVGID_128_)"
                    ...
                    >
                        <stop offset="0" style="stop-color:#489fe6" />
            ...
            <g>
                ...
                <linearGradient
                    ...
                    gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)"
                >
                    <stop offset="0" style="stop-color:#6cb2f4" />
                    <stop
                        offset="0.3874"
                        style="stop-color:#6cb2f4;stop-opacity:0.5873"
                    />
                    <stop
                        offset="0.9388"
                        style="stop-color:#FFFFFF;stop-opacity:0"
                ...
                >
                    ...
                    <stop
                        offset="0.1993"
                        style="stop-color:#6cb2f4;stop-opacity:0.8007"
                    />
                    <stop
                        offset="0.3919"
                        style="stop-color:#6cb2f4;stop-opacity:0.6081"
                    />
                    <stop
                        offset="0.5731"
                        style="stop-color:#6cb2f4;stop-opacity:0.4269"
                    />
                    <stop
                        offset="0.7399"
                        style="stop-color:#6cb2f4;stop-opacity:0.2601"
                    />
                    <stop
                        offset="0.8874"
                        style="stop-color:#6cb2f4;stop-opacity:0.1126"
                    />
                    <stop
                        offset="1"
                        style="stop-color:#6cb2f4;stop-opacity:0"
                    />
                </linearGradient>
                <polygon
                    class="particlespoly"
            ...
            <g>
                ...
                >
                    ...
                    <stop
                        offset="1"
                        style="stop-color:#256c95;stop-opacity:0"
                    />
                </linearGradient>
                <polygon
                    class="particlespoly"
...
.button{
    ...
    @for $i from 1 to 5 {
        #redblocksparticles g:nth-child(#{$i}) polygon {
            opacity: 0.35;
            animation: glow 5s 1s ease infinite;
        }
    }
    @for $i from 1 to 20 {
