<script lang="ts">
  ...
  if (typeof window.ethereum !== "undefined") {
    try {
      ...
      if (wasAdded) {
        console.log("Added Hydro Token on the Polygon network!");
      } else {
...
{#if $onExpectedNetworkPoly}
  ...
  <div
    on:click={addHydroPoly}
    disabled={!$onExpectedNetworkPoly}
  ...
  >
    ...
    <div class="text-add-hydro">Add Hydro on Polygon Network</div>
  </div>
{/if}
