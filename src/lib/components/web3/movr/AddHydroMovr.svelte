<script lang="ts">
  ...
  if (typeof window.ethereum !== "undefined") {
    try {
      ...
      if (wasAdded) {
        console.log("Added Hydro Token on the Moonriver Network!");
      } else {
...
{#if $onExpectedNetworkMovr}
  ...
  <div
    on:click={addHydroMovr}
    disabled={!$onExpectedNetworkMovr}
  ...
  >
    ...
    <div class="text-add-hydro">Add Hydro on Moonriver Network</div>
  </div>
{/if}
