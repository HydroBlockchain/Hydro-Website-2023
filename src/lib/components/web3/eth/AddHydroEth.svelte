<script lang="ts">
  ...
  if (typeof window.ethereum !== "undefined") {
    try {
      ...
      if (wasAdded) {
        console.log("Added Hydro Token on the Ethereum Network!");
      } else {
...
{#if $onExpectedNetworkEth}
  ...
  <div
    on:click={addHydroEth}
    disabled={!$onExpectedNetworkEth}
  ...
  >
    ...
    <div class="text-add-hydro">Add Hydro on Ethereum Network</div>
  </div>
{/if}
