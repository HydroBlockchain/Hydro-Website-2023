<script lang="ts">
  ...
  if (typeof window.ethereum !== "undefined") {
    try {
      ...
      if (wasAdded) {
        console.log("Added Hydro Token on CSC network!");
      } else {
...
{#if $onExpectedNetworkCsc}
  ...
  <div
    on:click={addHydroCsc}
    disabled={!$onExpectedNetworkCsc}
    class="button-add-hydro"
  >
    <svg
      id="coin-ticker-logo"
    ...
    <div class="text-add-hydro">Add Hydro on CSC Network</div>
  </div>
{/if}
