...
<div class="theme-switch" data-sveltekit-preload-data="hover" id="header-link" checked={currentTheme !==THEMES.DARK} on:click={toggleTheme}>
  {#if currentTheme === THEMES.DARK}
    <svg id="theme-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
	...
	{:else}
  <svg id="theme-icon" viewBox="0 0 27 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
