        ...
        <div class="wrapper">
            <div class="nav-wrapper" id="card-background" data-sveltekit-preload-data="hover">
                ...
                <div class="navigation" data-sveltekit-preload-data="hover">
                    <ThemeToggle />
                    <a class="header-link" data-sveltekit-preload-data="hover" aria-label="Hydro Technology" href="/tech">
                    ...
                    <a class="header-link" data-sveltekit-preload-data="hover" aria-label="Hydro Roadmap" href="/roadmap">
                    ...
                    <a class="header-link" data-sveltekit-preload-data="hover" aria-label="Exchanges & Partners" href="/exchanges">
                    ...
                    <a class="header-link" data-sveltekit-preload-data="hover" id="header-link-last" aria-label="Hydro FAQ" href="/faq">
