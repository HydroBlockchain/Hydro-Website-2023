        ...
        <div class="wrapper">
            <div class="nav-wrapper" id="card-background" data-sveltekit-preload-data="hover">
                ...
                <div class="navigation" data-sveltekit-preload-data="hover">
                    <ThemeToggle />
                    <a class="header-link" data-sveltekit-preload-data="hover" alt="Hydro Technology" href="/tech">
                    ...
                    <a class="header-link" data-sveltekit-preload-data="hover" alt="Team Hydro" href="/team">
                    ...
                    <a class="header-link" data-sveltekit-preload-data="hover" alt="Hydro Roadmap" href="/roadmap">
                    ...
                    <a class="header-link" data-sveltekit-preload-data="hover" alt="Exchanges & Partners" href="/exchanges">
                    ...
                    <a class="header-link" data-sveltekit-preload-data="hover" id="header-link-last" alt="Hydro FAQ" href="/faq">
